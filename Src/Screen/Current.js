  ...
  const renderItem = ({ item }) => {
    return (
      <View style={styles.mainView}>
        <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}} activeOpacity={0.9} onPress={() => { navigation.navigate('DetailScreen', { bill_id: item.bill_id }) }}>
    ...
    <View style={styles.container}>
      <Modal
        ...
        <View style={styles.modalView}>
          ...
          <TouchableOpacity activeOpacity={0.9} onPress={() => { setSelectedType("Others") }}>
