    ...
    return (
        <View style={styles.container}>
            ...
            <Animatable.View style={styles.imageview} animation="zoomInDown">
                <Image source={Imagepath.Consulting}
            ...
            <Animatable.View style={styles.Buttonview} animation="lightSpeedIn">
                <LinearGradient colors={["#7426f2", '#3d0891']} style={styles.touchabltext}>
                    <TouchableOpacity onPress={() => navigation.navigate('LoginScreen')} activeOpacity={0.9} >
            ...
            <View>
                <Animatable.View animation="zoomInDown">
                    <Image source={Imagepath.wave} style={{ tintColor: theme.colors.violet }} />
...
export const styles = StyleSheet.create({
    ...
    imageview: {
        backgroundColor: theme.colors.violet, width: '100%',
        borderBottomRightRadius: 30, borderBottomLeftRadius: 30,
    },
    imagestyle: {
        height: 350, width: '100%', alignItems: 'center',
        resizeMode: 'contain',
    },
    Buttonview: {
        marginTop: 45, marginHorizontal: 30
    },
    imagestylelogo: {
        marginHorizontal: 30, position: "absolute", bottom: 43
    },
    imagesour: {
    ...
    touchabltext: {
        height: 45, justifyContent: 'center', borderRadius: 7
    }
