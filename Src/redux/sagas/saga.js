...
function* addSuperAdminSaga({payload, error}) {
  try {
    const response = yield call(addSuperAdmin, payload);
    yield put({
...
export default function* saga() {
  ...
  yield takeEvery(types.SEND_REQUEST_ADD_SUPER_ADMIN, addSuperAdminSaga);
  ...
  yield takeEvery(
    types.SEND_REQUEST_IS_PHYSICALLY_SUBMITTED,
    isPhysicallySubmittedSaga,
  );
